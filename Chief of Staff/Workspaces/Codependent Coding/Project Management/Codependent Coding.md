...
pm-project: true
id: "klb30ky6lcbogzet"
title: "Codependent Coding™"
description: "Consolidate Codependent Coding into one executable product, canonicalize the source-backed Simples, complete and harden the Maximal Template, finish The Virgule™ + Hipster Stack™ + Anthimeria™, build Loaded Vibes™, and verify the system."
color: "#357b92"
icon: "🎯"
taskIds: ["i42wstxptn680fly", "512mrcv0rfcvsz91", "cwz4l3c0iee3814s", "i5tw3dd560kf8ngv", "5uhjxrd0yyhralze", "ti7yewh8watst7ue", "28dklimfqmydecwd", "kioh3vleg6fw39er", "yrbq00vjopk5d8s7"]
customFields: []
teamMembers: []
savedViews: []
...
Status: `INPUT[dn-status][:status]` · Priority: `INPUT[dn-priority][:priority]` · Health: `INPUT[dn-health][:health]`
