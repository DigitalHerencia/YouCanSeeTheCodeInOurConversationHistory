---
title: 'The Loaded Vibes™ Codex Plugin\.awesome\.github\workflows\codeowner-update.lock.yml'
type: source-document
scope: project
project: 'Codependent Coding'
domain: source
artifact: 'The Loaded Vibes™ Codex Plugin\.awesome\.github\workflows\codeowner-update.lock.yml'
kind: source-document
namespace: 'codependentcoding.source.the-loaded-vibes-codex-plugin.awesome.github.workflows.codeowner-update.lock.yml'
status: active
authority: reference
parent:
depends_on: []
...
created: 2026-08-18
updated: 2026-08-18
source_path: 'The Loaded Vibes™ Codex Plugin\.awesome\.github\workflows\codeowner-update.lock.yml'
source_file: 'codeowner-update.lock.yml'
source_sha256: 'eaa0305d2abea861ccc6ebb041252fb693bd5b54153bf789e733e47e8b5961ae'
generated: true
---
...
> Original path: `The Loaded Vibes™ Codex Plugin\.awesome\.github\workflows\codeowner-update.lock.yml`
> SHA-256: `eaa0305d2abea861ccc6ebb041252fb693bd5b54153bf789e733e47e8b5961ae`

```yaml
# gh-aw-metadata: {"schema_version":"v4","frontmatter_hash":"eee5557beebca58fbbe2106fb8577c61ac5c2c645edcd5e7c8aaa8b14d01e766","body_hash":"408df128d7b2623572ab8c06638b472d7e270daff1eb81c82ca24bf609125c25","compiler_version":"v0.84.3","strict":true,"agent_id":"copilot","engine_versions":{"copilot":"1.0.77"}}
  ...
  activation:
    ...
    steps:
      ...
      - name: Restore daily AIC usage cache
        ...
        with:
          key: agentic-workflow-usage-codeownerupdate-${{ github.run_id }}
          restore-keys: agentic-workflow-usage-codeownerupdate-
      ...
      - name: Create prompt with built-in context
        ...
        run: |
          ...
          {
          cat << 'GH_AW_PROMPT_5663b2ca88d5fd34_EOF'
          <system>
          GH_AW_PROMPT_5663b2ca88d5fd34_EOF
    ...
    steps:
      ...
      - name: Process no-op messages
        ...
        env:
          ...
          GH_AW_NOOP_MAX: "1"
          GH_AW_WORKFLOW_NAME: "Codeowner Update Agent"
          GH_AW_WORKFLOW_SOURCE_URL: "${{ github.server_url }}/${{ github.repository }}/blob/${{ github.ref_name }}/.github/workflows/codeowner-update.md"
          GH_AW_RUN_URL: ${{ github.server_url }}/${{ github.repository }}/actions/runs/${{ github.run_id }}
