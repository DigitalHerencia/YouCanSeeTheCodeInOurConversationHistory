...
created: 2026-04-26
description: "Learn about the features of ChatGPT agent mode and how to get started"
tags:
  - "Documentation"
  - "CodependentCoding"
  - "ChatGPT"
...
- **Business & Enterprise plans using** [**flexible pricing**](https://help.openai.com/en/articles/11487671-flexible-pricing-for-the-enterprise-and-team-plan)**:** 30 credits/message
...
Please note that each unique agent invocation will count against the monthly message limit. This includes agent requests that are part of [scheduled tasks](https://help.openai.com/en/articles/10291617-tasks-in-chatgpt).

## Apps

ChatGPT agent can use [**apps**](https://help.openai.com/en/articles/11487775-connectors-in-chatgpt) as additional data sources to leverage when conducting research. You should use extra caution when using apps with ChatGPT agent to prevent unauthorized access to sensitive information.
...
Chats, agent browsing history, and screenshots remain in your conversation history until you delete them. [Deleting a chat](https://help.openai.com/en/articles/8809935-how-to-delete-and-archive-chats-in-chatgpt) also deletes any associated screenshots.
...
Please refer to this [article](https://help.openai.com/en/articles/5722486-how-your-data-is-used-to-improve-model-performance) to understand how content may be used to improve model performance.
...
Workspace owners will be able to assign agent mode as available to specific roles. For more information about RBAC, please refer to our [documentation](https://help.openai.com/en/articles/11750701-rbac).
...
If you want to ensure that ChatGPT agent mode can access your website, follow the allowlisting steps outlined in the [ChatGPT agent allowlisting](https://help.openai.com/en/articles/11845367-chatgpt-agent-allowlisting) guide.