---
title: "Knowledge-Model.Authority-and-Ownership"
role: schemes
system: devnotes
workspace:
type: reference
...
|---|---|---|---|
| Epistemology | Trust Issues | How do we know? | DevNotes, Vibes, FYPM |
...
| Domain model | Schemes | How is business meaning represented? | Execution, FYPM |
| Knowledge graph | DevNotes | How are instances related? | all roles |

One owner prevents semantic forks. Other roles may apply the concept.
