...
Commands:
  ...
  quickadd              [QuickAdd]: Run a QuickAdd choice
    choice=<name>       - Choice name
    id=<id>             - Choice id
    vars=<json>         - Variables object as JSON
    ui                  - Allow interactive prompts

  quickadd:check        [QuickAdd]: Check missing inputs for a QuickAdd choice
    choice=<name>       - Choice name
    id=<id>             - Choice id
    vars=<json>         - Variables object as JSON

  quickadd:list         [QuickAdd]: List QuickAdd choices
    type=<Template|Capture|Macro|Multi>  - Filter by choice type
    commands            - Only include command-enabled choices

  quickadd:run          [QuickAdd]: Run a QuickAdd choice
    choice=<name>       - Choice name
    id=<id>             - Choice id
    vars=<json>         - Variables object as JSON
    ui                  - Allow interactive prompts
