        ...
        >
            ...
            >
                ...
                <Text color={activeTheme.muted}>
                    1 Launcher • 2 Dashboard • 3 Editor • 4 Clipboard • 5 Ops •
                    6 Differ • 7 Logger • 8 Prefer • ? Help • q Quit
                </Text>
                <Text color={activeTheme.primary}>
                    C copy instructions • R rerun diagnostics • D copy
                    diagnostics • H copy sanitized handoff
                </Text>
                <Text />
    ...
    return (
        ...
        >
            ...
            >
                ...
                <Text color={activeTheme.muted}>
                    ←/→ choose • Enter confirm • Esc cancel • default NO
                </Text>
            </Box>
        </Box>
    )
    ...
    return (
        ...
        >
            ...
            >
                ...
                <Text />
                <Text color={activeTheme.muted}>
                    s stage • u unstage • x revert(confirm) • p copy patch
                </Text>
            </Panel>
            {layout.showRight && (
                <Panel
...
export function EditorLtdScreen({
    ...
    return (
        ...
        >
            ...
            >
                <Text color={activeTheme.primary}>
                    Query: current target file index • Engine: local safe text
                    scan
                </Text>
                <Text />
                {rows.map(({ item, index }) => (
                ...
                <Text />
                <Text color={activeTheme.muted}>
                    Enter/e open external editor • r refresh index •
...
export function AppFrame({
    ...
    const statusMessage = isRunning ? `running • ${message}` : message
    ...
    return (
        ...
        >
            ...
            >
                ...
                <Text />
                <Text color={activeTheme.muted}>
                    t cycle theme • s write .rateltd/settings.json • other rows
        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        <Text color={activeTheme.primary}>
                            Package • Git • Search • PowerShell macros for the
                            active target.
                        </Text>
                        <Text />
            ...
            >
                ...
                >
                    ...
                    >
                        ...
                        <Text />
                        <Text color={activeTheme.muted}>
                            {controller.launcherStats.folders} folders •{" "}
...
function TreeRow({
    ...
    const prefix = `${selected ? "▶" : " "} ${indent}${iconForKind(entry)} `
    const suffix =
...
function iconForKind(entry: RepoTreeEntry): string {
    if (entry.kind === "root") return entry.isExpanded ? "▾" : "▸"
    if (entry.kind === "repo") return entry.isExpanded ? "▾ ▣" : "▸ ▣"
        ...
        >
            ...
            >
                ...
                >
                    ...
                    >
                        <Text color={activeTheme.primary}>
                            1. Clipboard Intake • detect payload type and build
                            a preview first.
                        </Text>
...
function WriterActionRow({
    ...
    const icon = action === "file-write" ? "◆" : "▶"
    const line = truncateLine(
        `${selected ? "▶" : " "} ${icon} ${label} — ${description}`,
        width,
    )
...
export const screenMetadata = {
    ...
    rate: {
        ...
        badge: "2 RATELTD",
        subtitle: "repo summary • recommended actions",
    },
    editor: {
        id: "editor",
        ...
        badge: "3 EDITORLTD",
        subtitle: "file list • preview • external editor",
    },
    write: {
        id: "write",
        ...
        subtitle: "clipboard intake • commands • writes",
    },
    ops: {
        id: "ops",
        displayName: "CommanderLtd",
    ...
    differ: {
        ...
        badge: "6 DIFFERLTD",
        subtitle: "status • split fallback • patch export",
    },
    output: {
        id: "output",
        ...
        badge: "7 LOGGERLTD",
        subtitle: "live output • logs • history",
    },
    prefer: {
        id: "prefer",
        ...
        badge: "8 PREFERLTD",
        subtitle: "settings • migration • safety",
    },
    confirm: {
        id: "confirm",
        displayName: "Confirm",
    ...
    "agent-help": {
        ...
        badge: "HELPLTD",
        subtitle: "shortcuts • troubleshooting • handoff",
    },
...
export function useMeatHarnessController(
    ...
    async function planClipboardAiCommand() {
        ...
        setWriteOutcome({
            ...
            detail: extracted.commands.join(" → "),
            filesChanged: 0,
        })
...
export function redactForLog(value: unknown): unknown {
    if (typeof value === "string") {
        ...
        return redacted.length > maxLoggedStringLength ?
                `${redacted.slice(0, maxLoggedStringLength)}…[TRUNCATED ${redacted.length - maxLoggedStringLength} chars]`
            :   redacted
    }
...
export function createTextWindow(
    ...
    if (options.overflowLabel !== false && overflowTop > 0) {
        labelledLines.unshift(`… ${overflowTop} line(s) above …`)
    }

    if (options.overflowLabel !== false && overflowBottom > 0) {
        labelledLines.push(`… ${overflowBottom} line(s) below …`)
    }
