...
7. Active Simple records and Source Mirror evidence.
8. Durable `60 CODEPENDENT CODING` doctrine where compatible.
...
- Source Mirror records preserve evidence/provenance; they do **not** prove physical repository state.
