---
title: 'The Loaded Vibes™ Codex Plugin\.notion\scripts\create-skill.ts'
type: source-document
scope: project
project: 'Codependent Coding'
domain: source
artifact: 'The Loaded Vibes™ Codex Plugin\.notion\scripts\create-skill.ts'
kind: source-document
namespace: 'codependentcoding.source.the-loaded-vibes-codex-plugin.notion.scripts.create-skill.ts'
status: active
authority: reference
parent:
depends_on: []
...
created: 2026-08-18
updated: 2026-08-18
source_path: 'The Loaded Vibes™ Codex Plugin\.notion\scripts\create-skill.ts'
source_file: 'create-skill.ts'
source_sha256: '05be00bf8e15cf628c76f1290bca7a3224bc329a938ecfaef51ed9b3e6cf12f3'
generated: true
---
...
> Original path: `The Loaded Vibes™ Codex Plugin\.notion\scripts\create-skill.ts`
> SHA-256: `05be00bf8e15cf628c76f1290bca7a3224bc329a938ecfaef51ed9b3e6cf12f3`
...
`;
    ...
    console.error(`❌ Error creating skill template: ${message}`);
    process.exit(1);
  } finally {
    rl.close();
  }
