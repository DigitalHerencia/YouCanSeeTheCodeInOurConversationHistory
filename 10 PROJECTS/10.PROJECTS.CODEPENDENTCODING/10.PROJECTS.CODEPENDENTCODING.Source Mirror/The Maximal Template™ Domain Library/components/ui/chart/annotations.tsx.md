---
title: 'The Maximal Template™ Domain Library\components\ui\chart\annotations.tsx'
type: source-document
scope: project
project: 'Codependent Coding'
domain: source
artifact: 'The Maximal Template™ Domain Library\components\ui\chart\annotations.tsx'
kind: source-document
namespace: 'codependentcoding.source.the-maximal-template-domain-library.components.ui.chart.annotations.tsx'
status: active
authority: reference
parent:
depends_on: []
...
created: 2026-08-18
updated: 2026-08-18
source_path: 'The Maximal Template™ Domain Library\components\ui\chart\annotations.tsx'
source_file: 'annotations.tsx'
source_sha256: '082f937ae294daef5e728bd5953c49d0468871d9d8c6971b523edb7df02b068c'
generated: true
---
...
> Original path: `The Maximal Template™ Domain Library\components\ui\chart\annotations.tsx`
> SHA-256: `082f937ae294daef5e728bd5953c49d0468871d9d8c6971b523edb7df02b068c`
...
export function arrowElements(
  spec: ChartArrowSpec,
  key?: React.Key,
): React.ReactElement[] {
  const k = String(key ?? "arrow");
  return [
    <ReferenceLine
      key={`${k}-line`}
      segment={[
...
export function renderChartAnnotations(
  ...
  annotations.forEach((a, i) => {
    if (a.kind === "referenceLine")
      out.push(referenceLineElement(a, `ann-${i}`));
