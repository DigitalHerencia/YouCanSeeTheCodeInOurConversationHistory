---
title: 'The Loaded Vibes™ Codex Plugin\.awesome\agents\se-responsible-ai-code.agent.md'
type: source-document
scope: project
project: 'Codependent Coding'
domain: source
artifact: 'The Loaded Vibes™ Codex Plugin\.awesome\agents\se-responsible-ai-code.agent.md'
kind: source-document
namespace: 'codependentcoding.source.the-loaded-vibes-codex-plugin.awesome.agents.se-responsible-ai-code.agent.md'
status: active
authority: reference
parent:
depends_on: []
...
created: 2026-08-18
updated: 2026-08-18
source_path: 'The Loaded Vibes™ Codex Plugin\.awesome\agents\se-responsible-ai-code.agent.md'
source_file: 'se-responsible-ai-code.agent.md'
source_sha256: 'e893e9c3c9c3475629094730221eca4f4d2bcff65875bd303bf6fb016600ba19'
generated: true
---
...
> Original path: `The Loaded Vibes™ Codex Plugin\.awesome\agents\se-responsible-ai-code.agent.md`
