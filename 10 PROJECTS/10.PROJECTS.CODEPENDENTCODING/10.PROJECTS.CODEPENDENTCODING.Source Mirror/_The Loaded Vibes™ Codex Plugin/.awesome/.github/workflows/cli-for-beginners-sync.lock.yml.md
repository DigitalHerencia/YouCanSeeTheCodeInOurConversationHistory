---
title: 'The Loaded Vibes™ Codex Plugin\.awesome\.github\workflows\cli-for-beginners-sync.lock.yml'
type: source-document
scope: project
project: 'Codependent Coding'
domain: source
artifact: 'The Loaded Vibes™ Codex Plugin\.awesome\.github\workflows\cli-for-beginners-sync.lock.yml'
kind: source-document
namespace: 'codependentcoding.source.the-loaded-vibes-codex-plugin.awesome.github.workflows.cli-for-beginners-sync.lock.yml'
status: active
authority: reference
parent:
depends_on: []
...
created: 2026-08-18
updated: 2026-08-18
source_path: 'The Loaded Vibes™ Codex Plugin\.awesome\.github\workflows\cli-for-beginners-sync.lock.yml'
source_file: 'cli-for-beginners-sync.lock.yml'
source_sha256: 'b3c83eacc2eca56ea5baf739630c4b08cdcd4227ea15d272f279664fc82269cf'
generated: true
---
...
> Original path: `The Loaded Vibes™ Codex Plugin\.awesome\.github\workflows\cli-for-beginners-sync.lock.yml`
> SHA-256: `b3c83eacc2eca56ea5baf739630c4b08cdcd4227ea15d272f279664fc82269cf`

```yaml
# gh-aw-metadata: {"schema_version":"v4","frontmatter_hash":"e3f2550d5791d43527217e604df3e07ee4354209a733e4beb18b02213af380f4","body_hash":"0b544aa6df7ccf92d28c3c515573894ba1ca9d2882c327c2ad4fb1e21644969e","compiler_version":"v0.84.3","strict":true,"agent_id":"copilot","engine_versions":{"copilot":"1.0.77"}}
...
on:
  schedule:
    - cron: "34 3 * * 5"  # Friendly format: weekly (scattered)
  workflow_dispatch:
    inputs:
      aw_context:
        default: ""
  ...
  activation:
    ...
    steps:
      ...
      - name: Restore daily AIC usage cache
        ...
        with:
          key: agentic-workflow-usage-cliforbeginnerssync-${{ github.run_id }}
          restore-keys: agentic-workflow-usage-cliforbeginnerssync-
      ...
      - name: Create prompt with built-in context
        ...
        run: |
          ...
          {
          cat << 'GH_AW_PROMPT_08855b4d37bd813d_EOF'
          <system>
    ...
    steps:
      ...
      - name: Process no-op messages
        ...
        env:
          ...
          GH_AW_NOOP_MAX: "1"
          GH_AW_WORKFLOW_NAME: "CLI for Beginners Content Sync"
          GH_AW_WORKFLOW_SOURCE_URL: "${{ github.server_url }}/${{ github.repository }}/blob/${{ github.ref_name }}/.github/workflows/cli-for-beginners-sync.md"
          GH_AW_RUN_URL: ${{ github.server_url }}/${{ github.repository }}/actions/runs/${{ github.run_id }}
