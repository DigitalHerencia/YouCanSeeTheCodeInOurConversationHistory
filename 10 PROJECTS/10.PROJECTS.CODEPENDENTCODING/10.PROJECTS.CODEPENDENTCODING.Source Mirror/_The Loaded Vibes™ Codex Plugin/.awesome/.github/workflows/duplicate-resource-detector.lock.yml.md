---
title: 'The Loaded Vibes™ Codex Plugin\.awesome\.github\workflows\duplicate-resource-detector.lock.yml'
type: source-document
scope: project
project: 'Codependent Coding'
domain: source
artifact: 'The Loaded Vibes™ Codex Plugin\.awesome\.github\workflows\duplicate-resource-detector.lock.yml'
kind: source-document
namespace: 'codependentcoding.source.the-loaded-vibes-codex-plugin.awesome.github.workflows.duplicate-resource-detector.lock.yml'
status: active
authority: reference
parent:
depends_on: []
...
created: 2026-08-18
updated: 2026-08-18
source_path: 'The Loaded Vibes™ Codex Plugin\.awesome\.github\workflows\duplicate-resource-detector.lock.yml'
source_file: 'duplicate-resource-detector.lock.yml'
source_sha256: '8ad6b754cb6e0b1d0fd7c2ae0ef5e141b70accb3909d6488d97ebe2131d1f667'
generated: true
---
...
> Original path: `The Loaded Vibes™ Codex Plugin\.awesome\.github\workflows\duplicate-resource-detector.lock.yml`
> SHA-256: `8ad6b754cb6e0b1d0fd7c2ae0ef5e141b70accb3909d6488d97ebe2131d1f667`

```yaml
# gh-aw-metadata: {"schema_version":"v4","frontmatter_hash":"a9f23f276f50c5d0ec075a2f482d2ef43d6cb7b3c7042624a461017cb9aeadff","body_hash":"7c3fdf5f640c39bf141ff08d56cd55682af71d86bf98d280b2f2483bdb71ce9b","compiler_version":"v0.84.3","strict":true,"agent_id":"copilot","engine_versions":{"copilot":"1.0.77"}}
...
on:
  schedule:
    - cron: "50 21 * * 4"  # Friendly format: weekly (scattered)
  workflow_dispatch:
    inputs:
      aw_context:
        default: ""
  ...
  activation:
    ...
    steps:
      ...
      - name: Restore daily AIC usage cache
        ...
        with:
          key: agentic-workflow-usage-duplicateresourcedetector-${{ github.run_id }}
          restore-keys: agentic-workflow-usage-duplicateresourcedetector-
      ...
      - name: Create prompt with built-in context
        ...
        run: |
          ...
          {
          cat << 'GH_AW_PROMPT_af09ff5961555d5c_EOF'
          <system>
          GH_AW_PROMPT_af09ff5961555d5c_EOF
    ...
    steps:
      ...
      - name: Generate Safe Outputs Config
        run: |
          ...
          cat > "${RUNNER_TEMP}/gh-aw/safeoutputs/config.json" << 'GH_AW_SAFE_OUTPUTS_CONFIG_c7960b6289755389_EOF'
      ...
      - name: Start MCP Gateway
        ...
        run: |
          ...
          cat << GH_AW_MCP_CONFIG_97b3378ba0132c28_EOF | "$GH_AW_NODE" "${RUNNER_TEMP}/gh-aw/actions/start_mcp_gateway.cjs"
          {
            "mcpServers": {
              "github": {
                "type": "stdio",
          ...
          GH_AW_MCP_CONFIG_97b3378ba0132c28_EOF
    ...
    steps:
      ...
      - name: Process no-op messages
        ...
        env:
          ...
          GH_AW_NOOP_MAX: "1"
          GH_AW_WORKFLOW_NAME: "Duplicate Resource Detector"
          GH_AW_WORKFLOW_SOURCE_URL: "${{ github.server_url }}/${{ github.repository }}/blob/${{ github.ref_name }}/.github/workflows/duplicate-resource-detector.md"
          GH_AW_RUN_URL: ${{ github.server_url }}/${{ github.repository }}/actions/runs/${{ github.run_id }}
