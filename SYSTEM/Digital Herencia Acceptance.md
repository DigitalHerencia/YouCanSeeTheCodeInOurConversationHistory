...
- Note Refactor selection extraction created a note containing the selected block through its live modal. The source note was not replaced with the expected link after completion, so source replacement/link persistence remains unverified.
